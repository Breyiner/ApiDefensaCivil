...
/**
 * Request de validación para actualizar completamente una mascota existente
 */
class UpdatePetRequest extends FormRequest
{
    ...
    /**
     * Reglas de validación para la actualización completa de mascotas
     * Todos los campos son obligatorios (PUT request)
     * 
